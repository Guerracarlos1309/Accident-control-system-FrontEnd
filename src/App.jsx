    ...
    <Router>
      <Routes>
        ...
        <Route path="/" element={<MainLayout />}>
          ...
          <Route path="setup/employees" element={<EntitySetupManager title="Directorio de Empleados" description="Administración de la nómina y datos del trabajador" entityName="Empleado" FormComponent={EmployeeForm} />} />
          <Route path="setup/vehicles" element={<EntitySetupManager title="Inventario de Vehículos" description="Gestión base automotriz" entityName="Vehículo" FormComponent={VehicleBaseForm} />} />
          <Route path="setup/extinguishers" element={<EntitySetupManager title="Inventario de Extintores" description="Red base de equipos contraincendios" entityName="Extintor" FormComponent={ExtinguisherBaseForm} />} />
