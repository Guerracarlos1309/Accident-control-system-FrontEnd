...
export default function UserForm({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res && !res.err) {
        showNotification(
          `Usuario ${isEditing ? "actualizado" : "creado"} con éxito`,
          "success",
        );
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              ...
              {isEditing && (
                <p className="text-[9px] text-txt-muted italic ml-1 mt-1">
                  El identificador de acceso no puede ser modificado.
                </p>
              )}
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-corpoelec-blue/5 border border-corpoelec-blue/10 rounded-2xl">
              ...
              <p className="text-[10px] text-txt-muted leading-relaxed">
                Asegúrese de asignar el rol correcto. Los administradores tienen
                acceso total a la gestión de datos sensibles.
              </p>
            </div>
          </div>
        </div>
