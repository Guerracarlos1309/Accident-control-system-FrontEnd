  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-txt-muted mt-1 text-xs font-bold uppercase tracking-widest">
            Catálogo técnico de plantas, subestaciones y oficinas.
          </p>
        </div>
      ...
      <div className="relative max-w-md">
        <div className="absolute left-4 top-1/2 -translate-y-1/2 text-txt-muted pointer-events-none"></div>
        <input
          type="text"
        ...
        {loading ? (
          ...
          <div className="text-center py-24 glass-panel rounded-[2.5rem] border-dashed border-border-main/50">
            ...
            <p className="text-txt-muted font-bold uppercase tracking-widest text-xs">
              No se encontraron instalaciones registradas.
            </p>
          </div>
        ) : viewMode === "grid" ? (
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            {filteredFacilities.map((facility) => (
              <div
                key={facility.id}
                className="glass-panel rounded-[2rem] p-6 group relative overflow-hidden transition-all hover:border-corpoelec-blue/30 shadow-sm hover:shadow-xl"
              >
                  ...
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <div className="flex flex-col items-end gap-1.5">
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-[9px] font-black text-txt-muted uppercase tracking-tighter">
                          Activa
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex flex-col">
                        <span className="text-[9px] font-black text-txt-muted uppercase tracking-widest italic leading-none mb-1">
                          Jurisdicción
                        </span>
                        <span className="text-xs text-txt-main font-bold">
                          {facility.location?.parish?.city?.name || "N/A"},{" "}
                          {facility.location?.parish?.name || "N/A"}
                        </span>
                        <span className="text-[10px] text-txt-muted font-medium mt-0.5">
                          Estado{" "}
                          {facility.location?.parish?.city?.state?.name ||
                            "N/A"}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-4 border-t border-border-main/50">
                      <div className="space-y-1">
                        ...
                        <span className="text-sm font-black text-txt-main">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] text-txt-muted font-mono">
                              {facility.coordinates || "Sin coordenadas"}
                            </p>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex flex-col">
                          ...
                          <p className="text-[10px] text-txt-muted">
                            Edo. {facility.location?.parish?.city?.state?.name}
                          </p>
                        </div>
                      </td>
                      <td className="px-6 py-4">
      ...
      <Modal
        ...
        title={
          editingFacility ? "Editar Instalación" : "Registro de Instalación"
        }
        maxWidth="max-w-4xl"
      >
        <FacilityForm
